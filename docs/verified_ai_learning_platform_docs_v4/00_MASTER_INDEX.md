...
- `sprints/phase04_problem_capture_and_canonicalization/SPRINT_4.3_IMPLEMENTATION_MAP.md` — Sprint 4.3 backend preprocessing, derivative asset, quality evidence, privacy, and no-OCR boundary mapping.
- `sprints/phase04_problem_capture_and_canonicalization/SPRINT_4.3_EXECUTION_REPORT.md` — Sprint 4.3 image preprocessing and capture-quality implementation evidence.
- `sprints/phase04_problem_capture_and_canonicalization/SPRINT_4.4_IMPLEMENTATION_MAP.md` — Sprint 4.4 recognition job/evidence, `VISION_PARSE` boundary, prompt/schema, privacy, and validation mapping.
...
- `sprints/phase05_ai_solving_and_verification_core/SPRINT_5.1_IMPLEMENTATION_MAP.md` — Sprint 5.1 provider-neutral AI gateway, capability model, route policy, usage ledger, and rollout implementation map.
