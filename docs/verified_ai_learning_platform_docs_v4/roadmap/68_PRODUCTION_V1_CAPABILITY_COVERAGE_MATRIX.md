...
| CAP-PRIV-001 | Account deletion, export, privacy controls | Yes | Sprint 3.7, Sprint 11.5 | `security/36_PRIVACY_AND_STUDENT_DATA_PROTECTION.md`, `data/23_DATA_LIFECYCLE_RETENTION_AND_AUDIT.md` | Partial | Sprint 3.7 implements account settings, current-user export, deletion request/confirmation, session revocation, profile deletion, commerce token removal, entitlement revocation, minimized billing retention, iOS local credential clearing, and lifecycle-contributor contracts. Future asset/problem/AI data stores must add contributors before completion. |
