# Sprint 1.2 — Ubiquitous Language and Non-Negotiable Domain Invariants

## Sprint mission

Turn product language into implementable semantics and ensure every engineer and agent uses the same definitions for Problem, Attempt, Solution, Verification, Mistake, Mastery, StudyPlan, and Entitlement.
