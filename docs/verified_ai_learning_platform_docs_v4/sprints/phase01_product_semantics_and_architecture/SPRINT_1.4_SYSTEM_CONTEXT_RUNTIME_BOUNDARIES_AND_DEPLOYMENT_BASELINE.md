# Sprint 1.4 — System Context, Runtime Boundaries, and Deployment Baseline

## Sprint mission

Define the iOS, Spring Boot, PostgreSQL, Redis, object storage, AI provider, and internal math-verifier boundaries and trust relationships.
