# Sprint 2.4 — PostgreSQL, Flyway, Persistence, and Testcontainers Foundation

## Sprint mission

Create production-like relational persistence locally and in tests, with immutable migrations and no H2 behavior divergence.
