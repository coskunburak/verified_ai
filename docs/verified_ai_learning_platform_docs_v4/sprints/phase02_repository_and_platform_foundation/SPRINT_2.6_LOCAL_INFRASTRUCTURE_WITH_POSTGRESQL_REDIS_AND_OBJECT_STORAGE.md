# Sprint 2.6 — Local Infrastructure with PostgreSQL, Redis, and Object Storage

## Sprint mission

Make the entire backend stack reproducibly runnable with Docker Compose and safe local seed data.
