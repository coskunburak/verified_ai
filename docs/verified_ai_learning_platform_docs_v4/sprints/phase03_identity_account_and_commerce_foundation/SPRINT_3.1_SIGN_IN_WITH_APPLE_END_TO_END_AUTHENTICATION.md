# Sprint 3.1 — Sign in with Apple End-to-End Authentication

## Sprint mission

Implement native Apple authentication and backend token verification with replay-safe nonce handling and account linking semantics.
