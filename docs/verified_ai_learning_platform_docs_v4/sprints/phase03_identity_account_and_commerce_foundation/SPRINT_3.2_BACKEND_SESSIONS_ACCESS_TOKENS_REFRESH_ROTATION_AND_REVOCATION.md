# Sprint 3.2 — Backend Sessions, Access Tokens, Refresh Rotation, and Revocation

## Sprint mission

Implement server-authoritative sessions with short-lived access tokens, rotating refresh-token families, reuse detection, logout, and device-session revocation.
