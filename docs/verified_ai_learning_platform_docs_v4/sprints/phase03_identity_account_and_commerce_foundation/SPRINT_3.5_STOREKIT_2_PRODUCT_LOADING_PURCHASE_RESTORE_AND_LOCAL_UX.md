# Sprint 3.5 — StoreKit 2 Product Loading, Purchase, Restore, and Local UX

## Sprint mission

Implement resilient client-side purchase flows, transaction observation, restore, interrupted purchase recovery, and transparent paywall states.
