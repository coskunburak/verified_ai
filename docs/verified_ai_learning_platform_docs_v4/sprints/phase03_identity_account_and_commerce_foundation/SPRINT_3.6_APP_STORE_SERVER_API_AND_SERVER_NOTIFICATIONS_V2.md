# Sprint 3.6 — App Store Server API and Server Notifications V2

## Sprint mission

Make backend billing state authoritative through validated App Store transactions and asynchronous subscription notifications.
