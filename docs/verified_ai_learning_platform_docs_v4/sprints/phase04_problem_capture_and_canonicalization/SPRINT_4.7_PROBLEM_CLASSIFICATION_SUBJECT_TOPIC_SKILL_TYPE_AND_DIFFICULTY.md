# Sprint 4.7 — Problem Classification: Subject, Topic, Skill, Type, and Difficulty

## Sprint mission

Map problems to stable curriculum skills and machine-usable problem types with confidence and review states.
