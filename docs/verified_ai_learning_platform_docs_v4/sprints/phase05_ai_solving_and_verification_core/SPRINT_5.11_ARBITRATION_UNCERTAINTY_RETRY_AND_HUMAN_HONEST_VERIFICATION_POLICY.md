# Sprint 5.11 — Arbitration, Uncertainty, Retry, and Human-Honest Verification Policy

## Sprint mission

Resolve solver disagreement without hiding uncertainty; only the verification policy may assign VERIFIED.
