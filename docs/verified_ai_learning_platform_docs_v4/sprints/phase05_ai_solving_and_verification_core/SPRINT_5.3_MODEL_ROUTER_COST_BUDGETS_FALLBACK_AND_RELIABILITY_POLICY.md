# Sprint 5.3 — Model Router, Cost Budgets, Fallback, and Reliability Policy

## Sprint mission

Route requests by capability, difficulty, latency target, entitlement, and cost budget while preventing runaway spend.
