# Sprint 5.7 — Verification Planner and Verification Method Selection

## Sprint mission

Choose deterministic and independent checks based on problem type instead of applying one generic validator.
