# Sprint 6.5 — Socratic Tutor Behavior and Pedagogical State Machine

## Sprint mission

Make Tutor Mode guide the learner with questions instead of immediately revealing answers whenever the selected policy requires productive struggle.
