# Sprint 7.6 — Mastery Model V1 and Deterministic Update Policy

## Sprint mission

Implement skill-level mastery using accuracy, difficulty, hints, attempt quality, and recency while avoiding opaque fake precision.
