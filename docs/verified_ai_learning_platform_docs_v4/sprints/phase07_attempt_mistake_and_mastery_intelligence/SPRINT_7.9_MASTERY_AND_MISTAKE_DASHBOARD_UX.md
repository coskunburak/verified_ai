# Sprint 7.9 — Mastery and Mistake Dashboard UX

## Sprint mission

Build understandable learner-facing visualizations that explain strengths, weaknesses, recurring mistake types, and recent movement.
...
## Phase-level engineering objective — Attempts, mistakes and mastery
...
### iOS / UX
- Define loading, empty, offline, retry, partial/degraded and accessibility states—not only happy path.
- Keep server-owned decisions read-only from the client and model them as typed states.
- Instrument user-visible latency and recovery without leaking private problem content.
