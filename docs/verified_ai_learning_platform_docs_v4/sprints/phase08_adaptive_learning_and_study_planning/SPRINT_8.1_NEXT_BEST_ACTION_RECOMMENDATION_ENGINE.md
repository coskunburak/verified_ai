# Sprint 8.1 — Next-Best-Action Recommendation Engine

## Sprint mission

Select what the learner should do next using weak skills, prerequisites, exam urgency, spacing, recent attempts, and available time.
