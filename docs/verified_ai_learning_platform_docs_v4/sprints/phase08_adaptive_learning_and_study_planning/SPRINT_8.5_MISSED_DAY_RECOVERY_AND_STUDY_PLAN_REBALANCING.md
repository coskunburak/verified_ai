# Sprint 8.5 — Missed-Day Recovery and Study Plan Rebalancing

## Sprint mission

Recompute future work after missed sessions, overload, or rapid mastery changes without punishing the learner.
...
## Phase-level engineering objective — Adaptive learning and planning
...
### Operations / Delivery
- Produce measurable SLO/capacity evidence and a rollback/runbook artifact.
- Test provider/model/configuration failures as first-class dependencies.
- Include AI spend/route anomalies in operational telemetry where applicable.
