# Sprint 8.6 — AI Micro-Lessons Triggered by Diagnosed Weaknesses

## Sprint mission

Generate short, bounded concept lessons only when the learning state indicates a clear misconception or knowledge gap.
