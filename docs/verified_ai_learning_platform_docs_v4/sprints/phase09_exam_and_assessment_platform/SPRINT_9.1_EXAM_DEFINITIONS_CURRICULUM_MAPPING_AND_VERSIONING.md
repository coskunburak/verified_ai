# Sprint 9.1 — Exam Definitions, Curriculum Mapping, and Versioning

## Sprint mission

Create stable exam models, syllabus mappings, skill weights, versions, and effective dates without hardcoding UI assumptions.
