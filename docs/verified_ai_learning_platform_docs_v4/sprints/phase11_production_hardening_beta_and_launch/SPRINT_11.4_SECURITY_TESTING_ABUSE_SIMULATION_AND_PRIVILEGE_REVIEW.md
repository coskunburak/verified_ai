# Sprint 11.4 — Security Testing, Abuse Simulation, and Privilege Review

## Sprint mission

Perform application security review covering authentication, authorization, SSRF/file handling, prompt injection, rate limits, admin access, and secret exposure.
