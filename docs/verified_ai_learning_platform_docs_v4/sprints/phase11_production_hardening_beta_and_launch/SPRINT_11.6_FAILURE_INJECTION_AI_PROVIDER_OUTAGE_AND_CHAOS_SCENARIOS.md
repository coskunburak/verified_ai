# Sprint 11.6 — Failure Injection, AI Provider Outage, and Chaos Scenarios

## Sprint mission

Test degraded operation for provider timeouts, object-storage failure, Redis loss, verifier failure, slow DB, and duplicate notifications.
