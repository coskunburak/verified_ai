...
- Fine-tune only on supported math domain and verified eligible examples.
- Benchmark final-answer accuracy, verifier pass, hard-tail failures and cost.
- Reject candidate if it cannot meet baseline or requires excessive fallback.
