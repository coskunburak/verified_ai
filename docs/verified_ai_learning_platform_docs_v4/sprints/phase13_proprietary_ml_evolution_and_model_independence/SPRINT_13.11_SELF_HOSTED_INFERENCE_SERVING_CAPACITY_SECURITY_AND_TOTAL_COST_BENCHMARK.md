...
- Benchmark GPU/runtime at realistic concurrency and utilization.
- Calculate TCO including idle capacity, autoscaling, engineering and incident overhead.
- Implement private serving endpoint, auth, limits, telemetry and external fallback.
