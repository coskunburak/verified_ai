...
- Run shadow comparison using production distribution.
- Canary 1% -> 5% -> 25% with automatic/manual rollback thresholds.
- Demonstrate provider/proprietary kill switch and restore external route without client release.
