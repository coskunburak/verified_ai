...
- Build 30/60/90-day cost attribution by capability and learner tier.
- Rank candidate tasks using monthly cost, volume, output boundedness, evaluation quality and strategic value.
- Create a replacement decision matrix with explicit no-go candidates.
