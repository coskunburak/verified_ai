...
- Build reproducible materialization pipeline and immutable manifests.
- Implement canonical fingerprints, semantic dedup and protected-split leakage checks.
- Define Bronze/Silver/Gold quality tiers and label provenance.
