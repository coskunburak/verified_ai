...
- Train/evaluate a compact skill/topic classifier against current economy-route baseline.
- Report per-skill confusion matrix, unknown/out-of-distribution handling and latency/cost.
- Run shadow mode before any production routing.
