...
- Use verified attempts/labels only according to eligibility policy.
- Evaluate macro-F1 plus high-impact mistake-category precision/recall.
- Preserve explanation/evidence contract and abstain on ambiguous cases.
