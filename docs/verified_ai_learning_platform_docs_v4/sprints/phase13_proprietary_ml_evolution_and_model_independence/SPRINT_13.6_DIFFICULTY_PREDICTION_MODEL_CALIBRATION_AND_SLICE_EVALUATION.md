...
- Define difficulty target/calibration source from observed learner evidence.
- Avoid target leakage from post-outcome fields unavailable at prediction time.
- Evaluate calibration and slice drift, not only ranking correlation.
