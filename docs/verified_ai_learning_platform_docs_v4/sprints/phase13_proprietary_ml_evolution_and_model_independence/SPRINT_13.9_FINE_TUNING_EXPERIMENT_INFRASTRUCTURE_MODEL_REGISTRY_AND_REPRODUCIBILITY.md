...
- Establish isolated training environment, experiment tracking, artifact checksums and model cards.
- Pin base-model licenses/versions and reproducible configs.
- Protect holdout test data from training pipeline access.
