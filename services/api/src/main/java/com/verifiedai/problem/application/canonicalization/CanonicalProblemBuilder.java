...
@Component
public final class CanonicalProblemBuilder {
    public static final String CANONICAL_SCHEMA_VERSION = "canonical-problem-v1";
    public static final String VERIFIER_SCHEMA_VERSION = "verifier-input-v1";
